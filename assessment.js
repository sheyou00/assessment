...
function removeAllChildren(element) {
  while (element.firstChild) { //子供の要素がある限り最初の要素を削除
 ...
 * JSdocu 関数に関する説明 
 *名前の文字列を渡すと診断結果を返す関数 
 * @param(関数における引数の説明) {string} userName ユーザーの名前
 * @return(結果の説明) {string} 診断結果 
 */
function assessment(userName) {
  ...
  // userName.charCodeAt(i)　→ それぞれの名前の登録番号みたいなものを示す
